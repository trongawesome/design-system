...
<AnchorLinks small>
  ...
  <AnchorLink>Clarity or Pixel perfection</AnchorLink>
</AnchorLinks>
...
<DoDontExample type="do" captionTitle="Spark joy" caption="Caption">

![Alt text](./images/visual-correction-do.png)

</DoDontExample>
</Column>
<Column colMd={4} colLg={4}>

<DoDontExample type="dont" captionTitle="Doesn't spark joy" caption="Caption">

![Alt text](./images/visual-correction-dont.png)
...
<DoDontExample type="do" aspectRatio="1:1" captionTitle="Spark joy" caption="Caption">

![Alt text](./images/perspective-do.png)

</DoDontExample>
</Column>
<Column colMd={4} colLg={4}>

<DoDontExample type="dont" aspectRatio="1:1" captionTitle="Doesn't spark joy" caption="Caption">

![Alt text](./images/perspective-dont.png)
...
<DoDontExample type="do" color="dark" captionTitle="Spark joy" caption="Caption">

![Icon overview](./images/icon-pixel-perfection-do.png)

</DoDontExample>
</Column>
<Column colMd={4} colLg={4}>

<DoDontExample type="dont"  color="dark" captionTitle="Doesn't spark joy" caption="Caption">

![Icon overview](./images/icon-pixel-perfection-dont.png)
